...
const EvolutionList = ({ pokemon }) => {
  const PokemonEv = {
    ...
    trigger2:
      (pokemon?.chain.evolves_to[0] != null) | undefined &&
      (pokemon?.chain.evolves_to[0].evolves_to[0] != null) | undefined
        ? pokemon?.chain.evolves_to[0].evolves_to[0].evolution_details[0]
    ...
    status2:
      ...
      (pokemon?.chain.evolves_to[0].evolves_to[0] != null) | undefined
        ? pokemon?.chain.evolves_to[0].evolves_to[0].evolution_details[0]
            .trigger.name == "use-item"
          ? pokemon?.chain.evolves_to[0].evolves_to[0].evolution_details[0].item
              .name
          : pokemon?.chain.evolves_to[0].evolves_to[0].evolution_details[0]
              .held_item
          ? "holding " +
    ...
    trigger3:
      (pokemon?.chain.evolves_to[0] != null) | undefined &&
      (pokemon?.chain.evolves_to[0].evolves_to[1] != null) | undefined
        ? pokemon?.chain.evolves_to[0].evolves_to[1].evolution_details[0]
            .trigger.name == "use-item"
          ? "using"
          : pokemon?.chain.evolves_to[0].evolves_to[1].evolution_details[0]
              .trigger.name
    ...
    status3:
      ...
      (pokemon?.chain.evolves_to[0].evolves_to[1] != null) | undefined
        ? pokemon?.chain.evolves_to[0].evolves_to[1].evolution_details[0]
            .trigger.name == "use-item"
          ? pokemon?.chain.evolves_to[0].evolves_to[1].evolution_details[0].item
              .name
          : pokemon?.chain.evolves_to[0].evolves_to[1].evolution_details[0]
              .held_item
          ? "holding " +
    ...
    Ev3:
      (pokemon?.chain.evolves_to[0] != null) | undefined &&
      (pokemon?.chain.evolves_to[0].evolves_to[1] != null) | undefined
        ? pokemon?.chain.evolves_to[0].evolves_to[1].species.name
        : null,
  };
  return (
    <div className={styles.Evolution}>
      {PokemonEv.pokemon == "eevee" ? (
        pokemon?.chain.evolves_to.map((evolution) => {
          const poke = {
            trigger:
            ...
            status:
              evolution.evolution_details[0].trigger.name == "use-item"
                ...
                : evolution.evolution_details[0].min_level != null
                ? evolution.evolution_details[0].min_level
                : evolution.evolution_details[0].min_happiness
                ? "Happiness " + evolution.evolution_details[0].min_happiness
                : null,
          };
          return (
              ...
              <div className={styles.Evolution__Trigger}>
                ...
                <Paragraph
                  title={
                    poke.trigger +
                    " " +
                    (poke.status != null ? poke.status : "")
                  }
                  size="16"
                ></Paragraph>
              </div>
              <PokemonEvolution pokemon={evolution.species.name} />
            </div>
          );
        })
      ) : PokemonEv.Ev1 != null ? (
