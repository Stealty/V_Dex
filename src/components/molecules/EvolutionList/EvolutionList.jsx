    ...
    return <div className={styles.Evolution}>
        {PokemonEv.pokemon == "eevee" ?
            pokemon.chain.evolves_to.map((evolution) => {
                const poke = {
                    trigger: (evolution.evolution_details[0].trigger.name == "use-item" ? "using" : evolution.evolution_details[0].trigger.name),
                    status: (evolution.evolution_details[0].trigger.name == "use-item" ? evolution.evolution_details[0].item.name : evolution.evolution_details[0].min_level != null ? evolution.evolution_details[0].min_level : evolution.evolution_details[0].min_happiness ? "Happiness " + evolution.evolution_details[0].min_happiness : null)
                };
                return <div className={styles.Evolution__EvolutionStatus}>
